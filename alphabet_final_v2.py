...
def final_v2(file_name):
    ...
    def rearrange_alphabet(alphabet, ordered_letters):
        """Rearanges the alphabet closer to the correct order using a list of
        known ordered letters"""
    ...
    def main(alphabet,word_list):
        ...
        for root, similar_words in generate_similar_words(word_list):
            ...
            alphabet = rearrange_alphabet(alphabet, ordered_letters)
...
"""
NOTES v2:
1. What's the best way to iterate by two's? Maybe something recursive?

2. What's the best way to determine the correct root length? Too short could be a problem
on long lists of very similar words, but too long won't yield enough results.
Is there a dynamic way to figure it out for different lists of words.
